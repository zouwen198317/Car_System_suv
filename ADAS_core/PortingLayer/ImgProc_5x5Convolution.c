...
//////////////////////////////////////////////////////////////////////////
void ImgProc_5x5Convolution(const UINT8 * restrict a_pucImgBuf, 
                            ...
                            )
{
    ...
    for(ulY = 0; ulY < a_ulProcHeight - 2; ulY++, ulRowIndex += a_ulBufferWidth)
    {
        IMG_conv_5x5_i8_c8s(a_pucImgBuf + ulRowIndex + a_ulProcStartX, a_pucImgOutBuf + ulRowIndex + a_ulProcStartX,
