...
static FLOAT64   g_alFM_v2_1_eFOV_V_Sparrow144 = 114.889100;          // in degree
static FLOAT64   g_alFM_v2_1_eFOV_H_Sparrow144 = 143.503668;          // in degree
static FLOAT64   g_alFM_v2_1_eUD_FOV_H_Sparrow144 = 123.666398;       // in degree, for 2D 反魚眼使用
static FLOAT64   g_alFM_v2_1_eFocalLength_Sparrow144 = 1.08115190;    // in mm
static UINT32    g_alFM_v2_1_ulSensorPixelWidth_Sparrow144 = 640;     // in pixel
static UINT32    g_alFM_v2_1_ulSensorPixelHeight_Sparrow144 = 480;    // in pixel
static UINT32    g_alFM_v2_1_ulSensorPixelSize_Sparrow144 = 5600;     // in nm
static FLOAT64   g_alFM_v2_1_eHResizeRatio_Sparrow144 = 1.1109375;               // in degree

static UINT32    g_alFM_v2_1_ulAngleTableScale_Sparrow144 = 1;
static UINT32    g_alFM_v2_1_ulCurveLength_Sparrow144 = alFM_v2_1_DISTORTION_CURVE_LENGTH;

const FLOAT64 g_alFM_v2_1_aeAngleDegree_Sparrow144[alFM_v2_1_DISTORTION_CURVE_LENGTH] = 
{
...
static FLOAT64 g_alFM_v2_1_aeRealHeight_Sparrow144[alFM_v2_1_DISTORTION_CURVE_LENGTH] = 
{
    0,              0.01601217,     0.0320299,      0.04805876,     0.06410431,     0.08017213,     0.0962678,      0.1123969,      0.12856504,     0.14477783,
    0.16104088,     0.17735983,     0.19374034,     0.21018805,     0.22670866,     0.24330784,     0.25999129,     0.27676473,     0.29363386,     0.31060442,
    0.32768212,     0.34487267,     0.3621818,      0.37961519,     0.39717853,     0.41487744,     0.43271755,     0.4507044,      0.4688435,      0.48714025,
    0.50560001,     0.52422799,     0.54302932,     0.56200895,     0.58117172,     0.60052224,     0.62006497,     0.6398041,      0.65974361,     0.67988717,
    0.70023818,     0.72079971,     0.74157446,     0.76256476,     0.78377257,     0.80519938,     0.82684626,     0.8487138,      0.87080211,     0.89311082,
    0.91563902,     0.9383853,      0.96134774,     0.9845239,      1.00791081,     1.03150504,     1.05530267,     1.0792993,      1.10349014,     1.12786998,
    1.15243325,     1.17717407,     1.20208626,     1.22716343,     1.25239898,     1.27778618,     1.30331823,     1.32898827,     1.35478944,     1.38071497,
    1.40675819,     1.43291259,     1.45917188,     1.48553003,     1.51198133,     1.53852046,     1.56514251,     1.59184309,     1.61861836,     1.64546513,
    1.67238096,     1.69936421,     1.72641422,     1.75353138,     1.78071736,     1.80797522,     1.83530966,     1.86272729,     1.89023691,     1.91784991,
    1.94558068,     1.97344715,     2.0014715,      2.0296809,      2.05810861,     2.08679525,     2.11579049,     2.14515534,     2.17496518,     2.20531405,
    2.23632083,     2.25267856,     2.28653809,     2.32166658,     2.35845027,     2.39746728
};

static FLOAT64 g_alFM_v2_1_aeRefHeight_Sparrow144[alFM_v2_1_DISTORTION_CURVE_LENGTH] = 
{
...
static FLOAT64 g_alFM_v2_1_aeDistortionCurve_Sparrow144[alFM_v2_1_DISTORTION_CURVE_LENGTH] = 
{
...
void alFM_v2_1_LoadModedCfg_Sparrow144(alFM_v2_1_ModelCfg * a_ptFM_v2_Cfg)
{
    ...
    a_ptFM_v2_Cfg->uwSrcSensorWidth = g_alFM_v2_1_ulSensorPixelWidth_Sparrow144;
    a_ptFM_v2_Cfg->ulSensorPixelSize = g_alFM_v2_1_ulSensorPixelSize_Sparrow144;
    a_ptFM_v2_Cfg->uwLengthOfDistortionCurve = g_alFM_v2_1_ulCurveLength_Sparrow144;
    a_ptFM_v2_Cfg->uwAngleTableScale = g_alFM_v2_1_ulAngleTableScale_Sparrow144;
    a_ptFM_v2_Cfg->eFocalLength = g_alFM_v2_1_eFocalLength_Sparrow144;
    a_ptFM_v2_Cfg->eFOV_H = g_alFM_v2_1_eFOV_H_Sparrow144;
    a_ptFM_v2_Cfg->eUD_FOV_H = g_alFM_v2_1_eUD_FOV_H_Sparrow144;
    a_ptFM_v2_Cfg->eHResizeRatio = g_alFM_v2_1_eHResizeRatio_Sparrow144;

    for(uwDI = 0; uwDI < g_alFM_v2_1_ulCurveLength_Sparrow144; uwDI++)
    {
        a_ptFM_v2_Cfg->aeAngleDegree[uwDI] = g_alFM_v2_1_aeAngleDegree_Sparrow144[uwDI];
        a_ptFM_v2_Cfg->aeRealHeight[uwDI] = g_alFM_v2_1_aeRealHeight_Sparrow144[uwDI];
#if 0
        a_ptFM_v2_Cfg->aeRefHeight[uwDI] = g_alFM_v2_1_aeRefHeight_Sparrow144[uwDI];
        a_ptFM_v2_Cfg->aeDistortion[uwDI] = g_alFM_v2_1_aeDistortionCurve_Sparrow144[uwDI];
#endif
    }
}
